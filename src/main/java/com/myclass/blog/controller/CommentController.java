...
public class CommentController {
    ...
    public  ResponseEntity<CommentDto> updateComent(@PathVariable(value = "postId") Long postId, @PathVariable(value = "commentId") Long commentId, @RequestBody CommentDto commentDto){
